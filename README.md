...
Nexstar has 200+ TV stations and is the largest local broadcaster in the United States. With that many stations, it can be difficult to keep track of where a station is located and the current time there, so I set forth to create a plugin to serve as a quick reference.
